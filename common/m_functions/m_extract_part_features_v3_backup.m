...
if strcmp(cur_feature,'pair')
    ...
    for i_cluster = 1:cluster_num
        ...
        x_i = trajectory_i(:,1:2:end);
        y_i = trajectory_i(:,2:2:end);
        ...
        location_x_i = location(VOI_select_id,2);
        location_y_i = location(VOI_select_id,3);
    ...
    for i_cluster = 1:cluster_num
        ...
        for j_cluster = i_cluster:cluster_num
            ...
            parts_pair_features(ind,:) = cur_pair_feat(:);
            %
